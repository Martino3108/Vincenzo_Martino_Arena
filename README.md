...
| :--- | :--- | :--- | :--- |
| **Rough Heston Calibration** | Built a Python library for calibration and pricing under the Rough Heston model, a pipeline for the regular Heston model is included and the results are compared | Python | [Repo](https://github.com/Martino3108/Rough_Heston_Calibration) |
